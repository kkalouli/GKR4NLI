...
<div class="alert alert-success tab" role="alert" style="width: 96%;">
  <p>XplainNLI is an interactive, user-friendly, visualization interface for NLI. It computes inference with
                                           		...
                                           		the pair with the correct label. More details in our paper (currently under review).</p>
</div>
...
<div id="additionalInfo">
	<h3 class="tab" id="publications">Publications</h3>
    	<ul>
			...
			Thilo  Spinner,  Udo  Schlegel,  Hannah  Schaefer,  and Menna El-Assady. 2020. IEEE Transactions on Visualization and Computer Graphics.
    		<li> <a href="http://aclweb.org/anthology/W19-3305/">GKR: Bridging the gap between symbolic/structural and distributional meaning representations</a> Kalouli,
    			A.-L., Richard Crouch and Valeria de Paiva. 2019, 1st International Workshop on Designing Meaning Representations (DMR) @ACL 2019.
    		<li> <a href="https://www.aclweb.org/anthology/P19-3003/">lingvis.io - A Linguistic Visual Analytics Framework</a> 
    		  El-Assady M., Wolfgang Jentner, Fabian Sperrle, Rita Sevastjanova,  Annette Hautli-Janisz, Miriam Butt, and Daniel Keim. 2019. ACL 2019 System Demo. 		
